...
public class DatePickerDialog extends AppCompatDialogFragment implements
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        okButton.setTypeface(ResourcesCompat.getFont(activity, R.font.inter_medium));
        ...
        cancelButton.setTypeface(ResourcesCompat.getFont(activity, R.font.inter_medium));
